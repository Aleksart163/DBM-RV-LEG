...
L.FilterInterrupts2 		= "Якщо кастер не є поточною ціллю/фокусом (завжди)\пили кік на кд (тільки для босів)"
L.FilterInterrupts3 		= "Якщо кастер не є поточною метою/фокусом (завжди)\пили кік на кд (бос і треш)"
