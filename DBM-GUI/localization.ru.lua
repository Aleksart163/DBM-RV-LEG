...
L.TranslationBy 			= "Swix, TOM_RUS, Tielle"
...
L.Area_EventSoundsFilters	= "Условия фильтра звуковых событий"
L.EventFilterDungMythicMusic= "Не воспроизводить музыку в подземельях в Мифик/Мифик+ сложностях"
L.EventFilterMythicMusic	= "Не воспроизводить музыку в рейдах в Мифик/Мифик+ сложностях"
