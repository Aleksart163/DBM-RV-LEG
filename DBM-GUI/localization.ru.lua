...
L.Statistic_BestRank		= "Лучший рейтинг:"
...
L.CVoiceOne					= "Вариант отсчёта 1"
L.CVoiceTwo					= "Вариант отсчёта 2"
L.CVoiceThree				= "Вариант отсчёта 3"
...
L.SpecWarn_MoveMe			= "Передвинь меня"
...
L.SWFNever					= "Никогда"
L.SWFDefaultOnly			= "Когда спец-предупреждения используют звуки по умолчанию"
...
L.Area_Restore				= "Параметры DBM для возврата настроек\n(восстанавливать ли предыдущее пользов. состояние по окончании работы модулей)"
...
L.FilterInterruptsHeader	= "Фильтровать предупреждения о прерываемых заклинаниях:"
L.FilterInterrupts			= "Если кастер не является вашей текущей целью или фокусом."
L.FilterInterrupts2			= "Если кастер не является текущей целью/фокусом (всегда)\nили кик на кд (только для боссов)"
L.FilterInterrupts3			= "Если кастер не является текущей целью/фокусом (всегда)\nили кик на кд (босс и треш)"
...
L.CreateProfile				= "Создать новый профиль с стандартными настройками"
