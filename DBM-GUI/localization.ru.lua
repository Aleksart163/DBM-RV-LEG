...
--
L.Area_Key					= "Параметры Эпохальных+ ключей и рейдов"
L.AutoKeyLink				= "Линковать свой Эпохальный+ ключ в чат"
L.IgnoreRaidAnnounce		= "Отключить рейдовые анонсы в чате (из специального модуля)"
