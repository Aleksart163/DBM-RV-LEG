...
local timerSpinningSpearCD		= mod:NewCDTimer(17, 162058, nil, "Tank", 2, 5, nil, DBM_CORE_TANK_ICON)
...
local yellMark					= mod:NewYell(163447, nil, nil, nil, "YELL")
local yellFreezingSnare			= mod:NewYell(162066, nil, nil, nil, "YELL")
