...
local timerDarkCommunionCD		= mod:NewCDTimer(45.7, 153153, nil, nil, nil, 1, nil, DBM_CORE_DAMAGE_ICON)--Can get delayed by a lot
local timerWhispersCD			= mod:NewCDTimer(30.4, 153094, nil, nil, nil, 2, nil, DBM_CORE_HEALER_ICON)--30.4-48
