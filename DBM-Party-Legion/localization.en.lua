...
L:SetMiscLocalization({
	EatingYell = "%s uses %s, now we have more hp!",
	SiphoningMagic = "%s uses %s, now we have more damage!",
	PurifyingYell = "%s uses %s, now we have more protection!",
	DrainingYell = "%s uses %s, now we have more critical damage!",
	InvokingTextYell = "%s uses %s, now we have more speed running!",
	DrinkingYell = "%s uses %s, now we have more mana and hp regen!",
	ReleaseSporesYell = "%s uses %s, now we have more combat speed!",
	ShuttingDownYell = "%s uses %s, now all the Guardian Construct will be turned off!",
	TreatingYell = "%s uses %s and distracting the mini-boss!",
	PilferingYell = "%s uses %s and distracting the mini-boss!",
	DefacingYell = "%s uses %s and distracting the mini-boss!",
	TinkeringYell = "%s uses %s and distracting the mini-boss!",
	--
