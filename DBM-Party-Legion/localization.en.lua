...
L:SetMiscLocalization({
	...
	--
	Gloves		= "[DBM RV] Wears gloves/Носит перчатки",
	NoGloves	= "[DBM RV] No gloves/Без перчаток",
	Cape		= "[DBM RV] Wearing a cape/Носит плащ",
	Nocape		= "[DBM RV] No cape/Без плаща",
	LightVest	= "[DBM RV] Light vest/Светлый жилет",
	DarkVest	= "[DBM RV] Dark vest/Темный жилет",
	Female		= "[DBM RV] Female/Женщина",
	Male		= "[DBM RV] Male/Мужчина",
	ShortSleeve = "[DBM RV] Short sleeves/Короткие рукава",
	LongSleeve	= "[DBM RV] Long sleeves/Длинные рукава",
	Potions		= "[DBM RV] Potions/Зелья",
	NoPotions	= "[DBM RV] No potions/Нет зелий",
	Book		= "[DBM RV] Book/Книга",
	Pouch		= "[DBM RV] Pouch/Кошель"
})
