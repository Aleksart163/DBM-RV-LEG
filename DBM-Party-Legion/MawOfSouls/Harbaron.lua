...
local specWarnScythe			= mod:NewSpecialWarningDodge(194216, nil, nil, nil, 2, 2) --Космическая коса

local timerFragmentCD			= mod:NewCDTimer(30, 194327, nil, nil, nil, 3) --Разделение
