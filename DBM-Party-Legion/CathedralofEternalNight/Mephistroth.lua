...
local warnShadowFadeEnded			= mod:NewEndAnnounce(233206, 2) --Уход во тьму
...
local specWarnCarrionSwarm			= mod:NewSpecialWarningSpell(233155, "Tank", nil, nil, 1, 2) --Темная стая
local specWarnDemonicUpheaval		= mod:NewSpecialWarningMoveAway(233963, nil, nil, nil, 3, 5) --Демоническое извержение

local timerDarkSolitudeCD			= mod:NewCDTimer(8.5, 234817, nil, nil, nil, 3) --Темное одиночество
local timerCarrionSwarmCD			= mod:NewCDTimer(18, 233155, nil, "Tank", nil, 5, nil, DBM_CORE_TANK_ICON) --Темная стая
local timerDemonicUpheavalCD		= mod:NewCDTimer(26.5, 233196, nil, nil, nil, 3) --Демоническое извержение 32-35
