...
local specWarnStaticNova			= mod:NewSpecialWarningStandSand(193597, nil, nil, nil, 3, 3)
local specWarnFocusedLightning		= mod:NewSpecialWarningStandWater(193611, nil, nil, nil, 3, 3)
local specWarnAdds					= mod:NewSpecialWarningSwitch(193682, "-Healer", nil, nil, 1, 2)
