...
L:SetMiscLocalization({
	EatingYell = "%s verwendet %s!",
	SiphoningMagic = "%s verwendet %s!",
	PurifyingYell = "%s verwendet %s!",
	DrainingYell = "%s verwendet %s!",
	InvokingTextYell = "%s verwendet %s!",
	DrinkingYell = "%s verwendet %s!",
	ReleaseSporesYell = "%s verwendet %s!",
	ShuttingDownYell = "%s verwendet %s!",
	TreatingYell = "%s verwendet %s!",
	PilferingYell = "%s verwendet %s!",
	DefacingYell = "%s verwendet %s!",
	TinkeringYell = "%s verwendet %s!",
	--
