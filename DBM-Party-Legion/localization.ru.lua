...
L:SetMiscLocalization({
	...
	Found			= "Ну-ну,",
	--
	Gloves		= "[DBM RV] Носит перчатки/Wears gloves",
	NoGloves	= "[DBM RV] Без перчаток/No gloves",
	Cape		= "[DBM RV] Носит плащ/Wearing a cape",
	Nocape		= "[DBM RV] Без плаща/No cape",
	LightVest	= "[DBM RV] Светлый жилет/Light vest",
	DarkVest	= "[DBM RV] Темный жилет/Dark vest",
	Female		= "[DBM RV] Женщина/Female",
	Male		= "[DBM RV] Мужчина/Male",
	ShortSleeve = "[DBM RV] Короткие рукава/Short sleeves",
	LongSleeve	= "[DBM RV] Длинные рукава/Long sleeves",
	Potions		= "[DBM RV] Зелья/Potions",
	NoPotions	= "[DBM RV] Нет зелий/No potions",
	Book		= "[DBM RV] Книга/Book",
	Pouch		= "[DBM RV] Кошель/Pouch"
})
