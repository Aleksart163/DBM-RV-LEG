...
L:SetMiscLocalization({
	EatingYell = "%s использует %s, теперь у нас больше хп!",
	SiphoningMagic = "%s использует %s, теперь у нас больше урона!",
	PurifyingYell = "%s использует %s, теперь у нас больше защиты!",
	DrainingYell = "%s использует %s, теперь у нас больше крита!",
	InvokingTextYell = "%s использует %s, теперь у нас больше скорости бега!",
	DrinkingYell = "%s использует %s, теперь у нас больше регена хп и маны!",
	ReleaseSporesYell = "%s использует %s, теперь у нас больше скорости боя!",
	ShuttingDownYell = "%s использует %s, теперь все Големы-стражи будут выключены!",
	TreatingYell = "%s использует %s и отвлекает мини-босса!",
	PilferingYell = "%s использует %s и отвлекает мини-босса!",
	DefacingYell = "%s использует %s и отвлекает мини-босса!",
	TinkeringYell = "%s использует %s и отвлекает мини-босса!",
	--
