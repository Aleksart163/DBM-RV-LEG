...
L:SetWarningLocalization({
--	DisableBeacon = "%s применяет заклинание Отключение маяка: 4.0 сек",
--	Eating = "%s применяет заклинание Поглощение пищи: 2.0 сек (+ хп)",
--	SiphoningMagic = "%s применяет заклинание Похищение магии: 2.0 сек (+ урон)",
--	Purifying = "%s применяет заклинание Очищение: 2.0 сек (+ защита)",
--	Draining = "%s применяет заклинание Иссушение: 2.0 сек (+ крит)",
--	ShuttingDown = "%s применяет заклинание Отключение: 2.0 сек",
--	InvokingText = "%s применяет заклинание Текст пробуждения: 2.0 сек (+ скорость бега)",
--	Drinking = "%s применяет заклинание Выпивание: 2.0 сек (+ хп и мана реген)",
--	ReleaseSpores = "%s применяет заклинание Высвобождение спор: 2.0 сек (+ скорость боя)",
--	Treating = "%s применяет заклинание Лечение: 2.0 сек (отвлечение)",
--	Pilfering = "%s применяет заклинание Воровство: 2.0 сек (отвлечение)",
--	Tinkering = "%s применяет заклинание Конструирование: 2.0 сек (отвлечение)",
	warnSpy = "Шпион обнаружен"
})

L:SetOptionLocalization({
--	DisableBeacon = "Предупреждать о применении заклинания $spell:210253",
...
--	ShuttingDown = "Предупреждать о применении заклинания $spell:208370",
--	InvokingText = "Предупреждать о применении заклинания $spell:210872",
--	Drinking = "Предупреждать о применении заклинания $spell:210307",
--	ReleaseSpores = "Предупреждать о применении заклинания $spell:208939",
--	Treating = "Предупреждать о применении заклинания $spell:210925",
--	Pilfering = "Предупреждать о применении заклинания $spell:210217",
--	Tinkering = "Предупреждать о применении заклинания $spell:210922",
...
L:SetMiscLocalization({
	EatingYell = "Использую Закуски ночной тени, теперь у нас больше хп!",
	SiphoningMagic = "Использую Магический светильник, теперь у нас больше урона!",
	PurifyingYell = "Использую Инфернальный фолиант, теперь у нас больше защиты!",
	DrainingYell = "Использую Сферу Скверны, теперь у нас больше крита!",
	InvokingTextYell = "Использую Промокший свиток, теперь у нас больше скорости бега!",
	DrinkingYell = "Использую Отвар из звездной розы, теперь у нас больше регена хп и маны!",
	ReleaseSporesYell = "Использую Теневой цветок, теперь у нас больше скорости боя!",
	ShuttingDownYell = "Использую Проводник магической энергии, теперь все Големы-стражи будут выключены!",
	TreatingYell = "Лечу Раненого ночнорожденного и отвлекаю мини-босса!",
	PilferingYell = "Использую Рыночные товары и отвлекаю мини-босса!",
	DefacingYell = "Использую Статую ночнорожденного в натуральную величину и отвлекаю мини-босса!",
	TinkeringYell = "Использую Выброшенный хлам и отвлекаю мини-босса!",
