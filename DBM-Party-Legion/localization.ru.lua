...
L:SetMiscLocalization({
	...
	TaintofSeaYell = "%s спадает. Берегись!"
})
...
--	ProshlyapAnala = "Скоро %s!",
	...
	Tip2 = "Призрак при \"Незримом присутствии\" появляется на неизвестном человеке, когда цель призрака пользуется BigWigs, имеет старую версию DBM, или не пользуется аддонами вообще. Во всех остальных случаях анонс с целью показывается правильно.\nСледите за обновлениями аддона.",
