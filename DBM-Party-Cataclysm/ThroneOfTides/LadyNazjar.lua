local mod	= DBM:NewMod(101, "DBM-Party-Cataclysm", 3, 65)
...
local warnFungalSpores		= mod:NewTargetNoFilterAnnounce(80564, 3, nil, "DiseaseDispeller", 2)
...
local timerFungalSpores		= mod:NewBuffFadesTimer(15, 80564, nil, "DiseaseDispeller", 2, 5, nil, DBM_CORE_DISEASE_ICON)
