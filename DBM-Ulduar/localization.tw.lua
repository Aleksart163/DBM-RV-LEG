...
L:SetWarningLocalization{
	warnTurretsReadySoon		= "10秒後 最後一座砲塔完成",
...
L:SetTimerLocalization{
	TimerSpeedKill		= "古神也作古",
	NextPortal			= "下一次 腦部傳送門"
}

L:SetOptionLocalization{
	WarningGuardianSpawned	= "$journal:17663 顯示特別警告",
	WarningCrusherTentacleSpawned = "$journal:17688 顯示特別警告",
