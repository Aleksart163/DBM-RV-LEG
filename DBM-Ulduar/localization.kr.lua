...
L:SetWarningLocalization{	
	...
	warnTurretsReadySoon		= "마지막 포탑 10초 전",
...
L:SetTimerLocalization{
	TimerSpeedKill = "이른 아침 상큼한 사로나이트 향기"
}
...
L:SetTimerLocalization{
	TimerSpeedKill		= "영원히 고대로",
	NextPortal			= "내부 차원문"
}

L:SetOptionLocalization{
	WarningGuardianSpawned			= "$journal:17663 소환 알리기",
	WarningCrusherTentacleSpawned	= "$journal:17688 생성 알리기",	
