...
L:SetTimerLocalization{
    TimerSpeedKill	= "Stokin' the Furnace"
}
...
L:SetWarningLocalization{	
	warnTurretsReadySoon		= "Last turret ready in 10 seconds",
...
L:SetTimerLocalization{
    TimerSpeedKill	= "Must Deconstruct Faster"
}
...
L:SetTimerLocalization{
    TimerSpeedKill	= "I Could Say That This Cache Was Rare"
}
...
L:SetTimerLocalization{
	TimerSpeedKill = "I Love the Smell of Saronite in the Morning"
}
...
L:SetTimerLocalization{
	TimerSpeedKill	= "He's Not Getting Any Older",
	NextPortal	= "Brain Portal"
}

L:SetOptionLocalization{
	WarningGuardianSpawned			= "Show warning for $journal:17663 spawns",
	WarningCrusherTentacleSpawned	= "Show warning for $journal:17688 spawns",
