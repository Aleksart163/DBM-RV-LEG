...
L:SetWarningLocalization{
	...
	warnTurretsReadySoon		= "Quatrième tourelle à harpon prête dans 10 Sec",
...
L:SetTimerLocalization{
    TimerSpeedKill	= "Casser est plus rapide que construire"
}
...
L:SetTimerLocalization{
	TimerSpeedKill			= "Pas de bras, pas de chocolat",
...
L:SetTimerLocalization{
    TimerSpeedKill	= "Jouons à casse-cache"
}
...
L:SetTimerLocalization{
	TimerSpeedKill		= "Ne jamais toucher au bouton rouge",
...
L:SetTimerLocalization{
	TimerSpeedKill = "J'aime l'odeur de la saronite au petit matin"
}
...
L:SetTimerLocalization{
	TimerSpeedKill		= "Il a fait son temps",
	NextPortal			= "Portail du Cerveau"
}

L:SetOptionLocalization{
	WarningGuardianSpawned			= "Annonce l'arrivée des $journal:17663",
	WarningCrusherTentacleSpawned	= "Annonce l'arrivée des $journal:17688",
