...
L:SetWarningLocalization{	
	warnTurretsReadySoon		= "Гарпунные пушки будут собраны через 10 секунд",
...
L:SetTimerLocalization{
	TimerSpeedKill = "Обожаю запах саронита по утрам"
}
...
L:SetOptionLocalization{
	WarningGuardianSpawned			= "Предупреждение о появлении $journal:17663",
	WarningCrusherTentacleSpawned	= "Предупреждение о появлении $journal:17688",
