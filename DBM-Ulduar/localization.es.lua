...
L:SetTimerLocalization{
    TimerSpeedKill	= "Avivar las llamas"
}
...
L:SetWarningLocalization{	
	warnTurretsReadySoon		= "La torreta estara lista en 10 segundos",
...
L:SetTimerLocalization{
    TimerSpeedKill	= "Hay que desarmar más deprisa"
}
...
L:SetTimerLocalization{
    TimerSpeedKill	= "Ya decía yo que este alijo era poco común"
}
...
L:SetTimerLocalization{
	TimerSpeedKill = "Adoro el olor a saronita al despertar"
}
...
L:SetTimerLocalization{
	TimerSpeedKill	= "No se volverá más antiguo",
	NextPortal	= "Portal cerebral"
}

L:SetOptionLocalization{
	WarningGuardianSpawned			= "Mostrar aviso cuando salga $journal:17663",
	WarningCrusherTentacleSpawned	= "Mostrar aviso cuando salga $journal:17688",
