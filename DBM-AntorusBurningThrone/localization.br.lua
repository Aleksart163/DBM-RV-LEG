...
L:SetMiscLocalization({
	ProshlyapMurchal = "%s %s (%s group) em 10 seg!",
	YellPullEonar = "Campeões! As forças da Legião querem roubar minha essência para o seu mestre infernal!",
...
L:SetOptionLocalization({
	ShowProshlyapSoulburnin = "Exibir aviso especial para $spell:244093 (requer status de líder/guia)"
})

L:SetMiscLocalization({
	ProshlyapSoulburnin = "%s %s em 5 segundos"
})
...
L:SetMiscLocalization({
	MurchalProshlyapation = "%s %s em breve",
