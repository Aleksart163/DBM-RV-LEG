...
local heroicBats = {158, 125, 78.5, 106} --у 1 -10сек, у 2 -3сек, у 3 -20сек
--Копье Рока героик----------------------------------------------------------------------------------------------------------------
--local heroicSpearofDoomTimers = {35, 59.2, 64.3, 40, 84.7, 34.1, 65.2}--Live, Nov 29
local heroicSpearofDoomTimers = {33.8, 60, 60, 60, 60, 60, 60} -- ВСЕ ГОТОВО у 1 -1сек, у 2 +0.8 сек, у 3 -4.3сек, у 4 +20сек, у 5 -25сек, у 6+ 26сек, у 7 хз, НО СКОРЕЕ ВСЕГО -5сек
-----------------------------------------------------------------------------------------------------------------------------------
--Дождь Скверны мифик--------------------------------------------------------------------------------------------------------------
...
function mod:OnCombatStart(delay)
	...
	if not self:IsLFR() then
		...
		--	timerRainofFelCD:Start(14 -delay, 1) --Дождь Скверны, подправил
			...
			timerSpearofDoomCD:Start(33.8-delay, 1) --Копье Рока
