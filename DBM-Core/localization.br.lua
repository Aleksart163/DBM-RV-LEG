...
DBM_CORE_AUTO_ANNOUNCE_TEXTS.targetsource  	= ">%%s< aplica um feitiço %s"
DBM_CORE_AUTO_ANNOUNCE_TEXTS.targetsource2  = ">%%s< aplica %s em >%%s<"
...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.targetsource	= "Anunciar alvos de $spell:%s (com fonte)"
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.targetsource2 = "Anunciar alvos de $spell:%s (para efeito de)"
...
DBM_CORE_AUTO_YELL_OPTION_TEXT.yellhelp	= "Gritar (pedir ajuda) quando estiver sendo atacado $spell:%s"
DBM_CORE_AUTO_YELL_OPTION_TEXT.yelldispel = "Gritar (pedir ajuda para dissipar) quando estiver sobre você $spell:%s"
--DBM_CORE_AUTO_YELL_OPTION_TEXT.yellmoveaway = "Кричать (с предупреждением \"отбегите\"), когда на вас $spell:%s"
DBM_CORE_AUTO_YELL_OPTION_TEXT.fade		= "Gritar (com contagem regressiva e nome do debuff) quando $spell:%s cai de você"
DBM_CORE_AUTO_YELL_OPTION_TEXT.fademoveaway	= "Gritar (com contagem regressiva e nome do debuff) quando $spell:%s cai de você"

DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yell	= "%s em " .. UnitName("player") .. "!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellhelp = "%s on me! AJUDEM!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yelldispel = "%s em mim! Dissipe-me!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellmoveaway = "%s on me! FUJAM DE MIM!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.count	= "%s em " .. UnitName("player") .. "! (%%d)"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fade	= "%s desaparece através %%d"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fademoveaway = "%s desaparece através %%d! FUJAM DE MIM!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.shortfade = "%%d"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.iconfade = "{rt%%2$d}%%1$d"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.position = "%s %%s em {rt%%d}"..UnitName("player").."{rt%%d}"
