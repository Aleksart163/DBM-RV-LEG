...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youclose			= "%s на >%%s< - разделите с ним урон"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.sharecount		= "%s! (%%s) - разделите урон"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.jump				= "%s - подпрыгните"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.run 				= "%s - убегайте"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.cast 				= "%s - прекратите свой каст!"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.interrupt2		= "Спец-предупреждение \"прервите каст контролем\" для заклинания $spell:%s"
