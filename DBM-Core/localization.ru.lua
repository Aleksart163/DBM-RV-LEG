...
DBM_COPY_URL_DIALOG					= "Посетите наш сайт для обновления на последнюю версию\r\n(привет прошляпанному очку администрации pandawow, а так же Kondibober и Jenrys, что предложили проект получше своего, для раскрытия моего таланта в области разработки аддонов)"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.closemoveaway		= "%s на >%%s< - отбегите от него"
