...
DBM_FORUMS_MESSAGE					= "Нашли баг или неправильный таймер? Считаете что какому-то модулю требуется дополнительное предупреждение, таймер, особенность или локализация?\nПо всем вопросам можете обращаться на discord |h|cff3588ffAleksart163|r или оставлять запросы на |h|cff3588ffhttps://github.com/Aleksart163/DBM-RV-DF/pulls|r\n|h|cffa0000fВНИМАНИЕ!|r С 2023 года временно объявляется прекращение поддержки данного аддона. Свою поддержку по-прежнему можно оказать на |h|cff3588ffhttps://www.donationalerts.com/r/aleksart163|r"
...
--
DBM_CORE_PROFILE_NOT_FOUND			= "<DBM RV> Ваш текущий профиль поврежден. DBM загрузит профиль 'По умолчанию'."
...
DBM_CORE_GENERIC_TIMER_COMBAT		= "Бой начнется через"
...
DBM_CORE_AUTO_ANNOUNCE_TEXTS.cast 			= "Применение %s: %.1f сек"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.yourunning		= "%s на тебе! - сбегитесь вместе"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.stack 			= "На тебе %%d стаков %s"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.switch 			= "%s - переключись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.switch2 			= "%s - переключись на >%%s<"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moredamage		= "%s - больше урону"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.switch2			= "Спец-предупреждение о смене цели, когда на ком-то $spell:%s"
...
DBM_CORE_AUTO_YELL_OPTION_TEXT.fademoveaway	= "Кричать (с обратный отсчетом, названием дебаффа и с предупреждением \"отбегите\"), когда $spell:%s с вас спадает"
...
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellhelp = "%s на мне! ПОМОГИТЕ!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yelldispel = "%s на мне! Диспел мне!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellmoveaway = "%s на мне!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.count	= "%s на " .. UnitName("player") .. "! (%%d)"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fade	= "%s спадает через %%d!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fademoveaway = "%s спадает через %%d!"
