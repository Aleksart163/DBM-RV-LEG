...
DBM_CORE_AUTO_YELL_OPTION_TEXT.fademoveaway	= "Кричать (с обратный отсчетом и названием дебаффа), когда $spell:%s с вас спадает"
...
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellmoveaway = "%s на мне! УЙДИТЕ ОТ МЕНЯ!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.count	= "%s на " .. UnitName("player") .. "! (%%d)"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fade	= "%s спадает через %%d"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fademoveaway = "%s спадает через %%d! УЙДИТЕ ОТ МЕНЯ!"
