...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soonlookaway		= "Скоро %s - отвернитесь"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youdispel 		= "%s на вас - рассейте"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targethelp 		= "%s на >%%s< - помогите"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetdodge 		= "%s на >%%s< - избегайте"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetsoak 		= "%s на >%%s< - перекройте"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetrun 		= "%s на >%%s< - бегите"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetint 		= "%s на >%%s< - прервите каст!"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmove 			= "%s под вами - отбеги"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dontmove 			= "%s! - не двигайся"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youdontmove 		= "%s под вами! - не двигайся"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dontstand 		= "%s! - не стой на месте"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youdontstand 		= "%s на вас! - не стой на месте"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmoveaway 		= "%s на вас! - отбеги от других"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youshare			= "%s на вас! - раздели урон с другими"
