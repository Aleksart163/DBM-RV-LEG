...
DBM_CORE_NEED_SUPPORT				= "Вы - программист или хороший переводчик? Если да, то нам нужна ваша помощь в локализации DBM на другие языки. Помогите нам, посетив |HDBM:forums|h|cff3588ffhttps://github.com/Aleksart163/DBM-for-Uwow|r.\nНашли баг или неправильный таймер? Вы считаете что какому-то модулю требуется дополнительное предупреждение, таймер или особенность?\nПосетите новые форумы DBM для обсуждений, сообщений об ошибках и запроса новых возможностей на |HDBM:forums|h|cff3588ffhttps://github.com/Aleksart163/DBM-for-Uwow|r."
