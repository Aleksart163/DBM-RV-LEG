...
DBM_CORE_NEED_SUPPORT				= "Вы - программист или хороший переводчик? Если да, то нам нужна ваша помощь в локализации DBM на другие языки. Помогите нам, посетив |HDBM:forums|h|cff3588ffhttps://github.com/Aleksart163/DBM-for-Legion|r.\nНашли баг или неправильный таймер? Вы считаете что какому-то модулю требуется дополнительное предупреждение, таймер или особенность?\nПосетите новые форумы DBM для обсуждений, сообщений об ошибках и запроса новых возможностей на |HDBM:forums|h|cff3588ffhttps://github.com/Aleksart163/DBM-for-Legion|r."
...
DBM_CORE_MOD_AVAILABLE				= "Для этого контента доступен дополнительный модуль %s. Вы можете скачать его с |HDBM:forums|h|cff3588ffhttps://github.com/Aleksart163/DBM-for-Legion|r. Это сообщение отображается один раз."
...
DBM_CORE_UPDATEREMINDER_TESTVERSION		= "ПРЕДУПРЕЖДЕНИЕ: Вы используете версию Deadly Boss Mods, не предназначенную для использования с данной версией игры. Пожалуйста, убедитесь, что вы загрузили подходящую версию для вашего игрового клиента с сайта " .. DBM_CORE_UPDATEREMINDER_URL .. "."
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmoveawaypos	= "%s (Поз. %%s) на вас"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.targethelp 		= "Спец-предупреждение \"помогите\", когда на ком-то $spell:%s"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.sharecount		= "Спец-предупреждение (со счетчиком) \"поделите урон между собой\" для $spell:%s"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.baitcondi		= "Спец-предупреждение (со счетчиком) \"прошляпай своё очко!\" для байта бобра во время действия $spell:%s"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.baitpel			= "Спец-предупреждение (со счетчиком) \"прошляпай своё очко!\" для байта пелии во время действия $spell:%s"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.baitmur			= "Спец-предупреждение (со счетчиком) \"прошляпай своё очко!\" для байта мурчаля во время действия $spell:%s"
...
DBM_CORE_DUR_HEADER					= "Deadly Boss Mods - результаты прочности"
