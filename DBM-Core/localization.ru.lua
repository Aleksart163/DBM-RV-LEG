...
DBM_CORE_AUTO_TIMER_TEXTS.cd 			= "кд %s"
DBM_CORE_AUTO_TIMER_TEXTS.cdcount		= "кд %s (%%s)"
DBM_CORE_AUTO_TIMER_TEXTS.cdsource		= "кд %s: >%%s<"
DBM_CORE_AUTO_TIMER_TEXTS.cdspecial		= "кд спец-способность"
DBM_CORE_AUTO_TIMER_TEXTS.next 			= "кд %s"
DBM_CORE_AUTO_TIMER_TEXTS.nextcount		= "кд %s (%%s)"
DBM_CORE_AUTO_TIMER_TEXTS.nextsource	= "кд %s: >%%s<"
DBM_CORE_AUTO_TIMER_TEXTS.nextspecial	= "кд спец-способность"
