...
DBM_CORE_MOD_AVAILABLE				= "Для этого контента доступен дополнительный модуль %s. Вы можете скачать его с |HDBM:forums|h|cff3588ffhttps://github.com/Aleksart163/DBM-RV|r. Это сообщение отображается один раз."
...
--DBM_SUMMON1							= " получил суммон от "
--DBM_SUMMON2							= " принял суммон"
--Common Locals end
...
DBM_CORE_AUTO_ANNOUNCE_TEXTS.endtarget		= "%s заканчивается на >%%s<"
...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.targetsource2 = "Объявлять (с целью) источник использования заклинания $spell:%s"
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.targetsourcecount = "Объявлять (со счетчиком) источник использования заклинания $spell:%s"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youfades			= "%s спадает c тебя"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soon				= "Скоро %s"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soonparaxiscount	= "Скоро %s - %%s группа"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soonlookaway		= "Скоро %s - отвернись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.prewarn			= "%s через %s"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dispel 			= "%s на |3-5(>%%s<) - рассей"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.interrupt			= "%s - прерви каст!"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.interrupt2		= "%s - прерви каст контролем!"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.interruptcount	= "%s - прерви каст! (%%d)"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.interruptcount2	= "%s! (%%s) - прерви каст"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.you 				= "%s на тебе"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youdispel 		= "%s на тебе - рассей"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youcount			= "%s (%%s) на тебе!"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youpos			= "%s (%%s) на тебе"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soak				= "%s! - перекрой"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soakcount			= "%s (%%s) - перекрой"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.soakpos			= "%s (Позиция погл.: %%s)"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.target 			= "%s на >%%s<"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targethelp 		= "%s на >%%s< - помоги"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetdodge 		= "%s на >%%s< - избегай"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetsoak 		= "%s на >%%s< - перекрой"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetrun 		= "%s на >%%s< - беги"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetint 		= "%s на >%%s< - прерви каст!"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.targetcount		= "%s (%%s) на >%%s< "
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youdefensive 		= "%s на тебе! - защитись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.defensive			= "%s! - защитись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.defensivecount 	= "%s! (%%s) - защитись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.taunt				= "%s на >%%s< - затаунти"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youclose			= "%s на >%%s< - раздели с ним урон"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.close 			= "%s на |3-5(>%%s<) около тебя"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.closemoveaway		= "%s на >%%s< - отбеги"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.move 				= "%s - отбеги"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmove 			= "%s под тобой - отбеги"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dontmove 			= "%s! - не двигайся"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youdontmove 		= "%s под тобой! - не двигайся"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dontstand 		= "%s! - не стой на месте"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youdontstand 		= "%s на тебе! - не стой на месте"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dodge				= "%s - избегай"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dodgecount		= "%s (%%s) - избегай"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.dodgeloc			= "%s - уклоняйся от %%s"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmoveaway 		= "%s на тебе! - отбеги от других"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmoveawaypos	= "%s (%%s) на тебе"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moveaway			= "%s - отбеги от других"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moveboss			= "%s - беги к боссу"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moveto			= "%s - беги к >%%s<"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmovetopos		= "%s (%%s) на тебе! - беги к метке"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youshare			= "%s на тебе! - раздели урон с другими"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.share				= "%s! - раздели урон"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.sharecount		= "%s! (%%s) - раздели урон"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.jump				= "%s - подпрыгни"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.run 				= "%s - убегай"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.yourun 			= "%s на тебе! - убегай"
...
DBM_CORE_AUTO_SPEC_WARN_TEXTS.cast 				= "%s - прерви свой каст!"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.lookaway			= "%s! - отвернись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youlookaway2		= "%s на тебе! - отвернись от других"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youlook			= "%s на тебе! - смотри на >%%s<"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youfind			= "%s на тебе! - верни свою душу"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.reflect 			= "%s на |3-5(>%%s<) - прекрати атаку"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.count 			= "%s! (%%s)"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.stack 			= "На тебе %%d стаков от %s"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.switch 			= "%s - переключись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.switchcount 		= "%s - переключись (%%s)"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.gtfo				= "%%s под тобой - отойди"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.Adds				= "Прибытие треша - переключись"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.Addscustom		= "Прибытие треша - %%s"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.icepud 			= "%s! - беги в лужу льда"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.moredamage		= "%s на >%%s< - больше урону"
DBM_CORE_AUTO_SPEC_WARN_TEXTS.youmoredamage		= "%s на тебе! - дай больше урона"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.soonparaxiscount = "Спец-предупреждение (со счетчиком группы) что скоро $spell:%s"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.soonlookaway 	= "Спец-предупреждение \"отвернитесь\", когда скоро $spell:%s"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.youdispel 		= "Спец-предупреждение для рассеивания заклинания когда на вас $spell:%s"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.icepud			= "Спец-предупреждение \"беги в лужу льда\" во время действия $spell:%s"
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.moredamage		= "Спец-предупреждение \"больше урона\" когда на ком-то $spell:%s"
...
DBM_CORE_MOVE_WARNING_MESSAGE		= "Спасибо за использование DBM Right Version" --Dungeon Boss Master
