...
DBM_CORE_AUTO_YELL_OPTION_TEXT.yellhelp	= "Crier (demander de l'aide) quand vous êtes affecté par $spell:%s"
DBM_CORE_AUTO_YELL_OPTION_TEXT.yelldispel = "Crier (demander de l'aide à la dispersion) quand vous êtes affecté par $spell:%s"
DBM_CORE_AUTO_YELL_OPTION_TEXT.yellmoveaway = "Crier (avec avertissement "fuyez") quand vous êtes affecté par $spell:%s"
...
DBM_CORE_AUTO_YELL_OPTION_TEXT.fademoveaway = "Crie (avec compte à rebours) lorsque $spell:%s se dissipe"
...
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellhelp 	= "%s sur moi! AIDEZ-MOI!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yelldispel = "%s sur moi! Dispersez-moi!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellmoveaway = "%s sur moi! ÉLOIGNEZ-VOUS DE MOI!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.count		= "%s sur " .. UnitName("player") .. "! (%%d)"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fade		= "%s disparaît dans %%d!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fademoveaway = "%s disparaît dans %%d! Ne m'approchez pas !"
