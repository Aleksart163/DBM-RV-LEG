...
DBM_CORE_AUTO_YELL_OPTION_TEXT.yellhelp	= "Gritar (pidiendo ayuda), cuando $spell:%s esta sobre ti $spell:%s"
DBM_CORE_AUTO_YELL_OPTION_TEXT.yelldispel = "Gritar (pidiendo disipacion) cuando $spell:%s esta sobre ti $spell:%s"
DBM_CORE_AUTO_YELL_OPTION_TEXT.yellmoveaway = "Gritar (avisando de \"Alejaros de mi\"), cuando $spell:%s esta sobre ti $spell:%s"
...
DBM_CORE_AUTO_YELL_OPTION_TEXT.fademoveaway = "Gritar (con duración restante y tu nombre) cuando $spell:%s esté a punto de expirar"
...
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellhelp 	= "%s en mi! Ayudadme!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yelldispel = "%s en mi! Disiparme!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.yellmoveaway = "%s en mi! Alejaros de mi!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.count		= "¡%s en " .. UnitName("player") .. "! (%%d)"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fade		= "%s expirando en %%d!"
DBM_CORE_AUTO_YELL_ANNOUNCE_TEXT.fademoveaway = "%s expirando en %%d! ¡Aléjate de mí!"
